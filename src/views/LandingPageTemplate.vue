...
import { MapPin, Home, Check } from 'lucide-vue-next'
...
interface Props {
    ...
    description: string
    heroImage?: string
    highlights: { icon: Component; label: string; value: string }[]
    features: string[]
    ...
    <main>
        ...
        <section class="relative min-h-[60vh] flex items-center overflow-hidden">
            ...
            <div class="absolute inset-0">
                <img :src="heroImage" :alt="`${city}, Arkansas`" class="w-full h-full object-cover" />
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="hidden lg:block">
                        <div class="bg-base-100 rounded-2xl p-8 shadow-2xl max-w-md ml-auto">
                            ...
                            <LeadForm :source="`area-${city.toLowerCase()}`" submit-label="Start My Alerts" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="listings" class="py-16">
            <div class="container-custom">
                ...
                <IdxEmbed type="search" :search-params="searchParams" height="600px" />
            </div>
        </section>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-primary-content/80 mb-6">
                            Work with the Ruby Poole Team - local experts with 11+ years of experience and 1,274+ homes
                            sold in Northwest Arkansas.
                        </p>
                    ...
                    <div class="bg-base-100 text-base-content rounded-2xl p-8 shadow-2xl">
                        ...
                        <LeadForm :source="`area-${city.toLowerCase()}-cta`" submit-label="Get Started" />
                    </div>
                </div>
            </div>
        </section>
