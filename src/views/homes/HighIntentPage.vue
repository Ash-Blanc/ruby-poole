...
const config = configs[props.intentType] || configs['under-400k']
</script>
    ...
    <section class="py-16 bg-base-200/50">
      <div class="container-custom">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div v-for="(feature, idx) in config.features" :key="idx" class="flex items-start gap-3 p-4 bg-base-100 rounded-xl">
      ...
      <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p class="text-primary-content/80">Tell us what matters most — we'll match you with the right properties.</p>
          </div>
