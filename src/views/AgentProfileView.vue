...
import { Star, Phone, Mail, Award, MapPin, Check, ArrowLeft } from 'lucide-vue-next'
    ...
    <main>
      ...
      <section class="py-16 bg-gradient-to-br from-base-100 via-base-200/50 to-primary/5">
        <div class="container-custom">
          <RouterLink to="/team" class="inline-flex items-center gap-2 text-sm text-base-content/60 hover:text-primary mb-8">
          ...
          <div class="grid lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
              ...
              <div class="flex flex-wrap gap-2 mb-8">
                <span v-for="specialty in agent.specialties" :key="specialty" class="badge badge-primary badge-outline py-3 px-4">
                  {{ specialty }}
                </span>
              </div>
