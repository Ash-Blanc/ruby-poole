...
import { Calendar, User, ArrowLeft, Facebook, Linkedin } from 'lucide-vue-next'
import SeoHead from '@/components/SeoHead.vue'
import BlogSidebar from '@/components/blog/BlogSidebar.vue'
import LeadForm from '@/components/LeadForm.vue'
import { getPostBySlug, getRecentPosts } from '@/components/data/blogPosts'
                ...
                <div class="container-custom">
                    <div class="grid lg:grid-cols-3 gap-12">
                        ...
                        <div class="lg:col-span-2">
                            <!-- Back Link -->
                            <RouterLink to="/blog"
                                class="inline-flex items-center gap-2 text-sm text-base-content/60 hover:text-primary mb-6">
                            ...
                            <header class="mb-8">
                                <div class="flex items-center gap-4 text-sm text-base-content/60 mb-4">
                                    <RouterLink :to="`/blog?category=${encodeURIComponent(post.category)}`"
                            ...
                            <div class="flex items-center gap-4 py-6 border-t border-base-200">
                                ...
                                <div class="flex gap-2">
                                    <a :href="`https://www.facebook.com/sharer/sharer.php?u=${shareUrl}`"
                                        ...
                                        class="btn btn-ghost btn-sm btn-square" aria-label="Share on Facebook">
                                        <Facebook class="w-4 h-4" />
                                    </a>
                                    <a :href="`https://www.linkedin.com/shareArticle?mini=true&url=${shareUrl}&title=${encodeURIComponent(post.title)}`"
                                        target="_blank" rel="noopener noreferrer"
                                        class="btn btn-ghost btn-sm btn-square" aria-label="Share on LinkedIn">
