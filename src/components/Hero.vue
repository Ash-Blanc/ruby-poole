...
<template>
    <section id="home" class="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="/images/hero.jpg" alt="Northwest Arkansas neighborhood community"
        ...
        <div class="container-custom relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="text-center lg:text-left">
                    <div
                        class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white/90 px-4 py-2 rounded-full text-sm font-medium mb-8 border border-white/10">
                    ...
                    <div class="mb-8 max-w-lg mx-auto lg:mx-0">
                        ...
                        <div class="flex flex-wrap gap-2 mt-3 justify-center lg:justify-start">
                            <RouterLink to="/search"
                                class="text-xs text-white/50 hover:text-primary transition-colors flex items-center gap-1">
                                <ChevronRight class="w-3 h-3" />
                                Advanced Search
                            </RouterLink>
                            <span class="text-white/20">•</span>
                            <RouterLink to="/school-districts"
                                class="text-xs text-white/50 hover:text-primary transition-colors flex items-center gap-1">
                                <ChevronRight class="w-3 h-3" />
                                Search by School District
                            </RouterLink>
                            <span class="text-white/20">•</span>
                            <RouterLink to="/homes/lake-homes"
                                class="text-xs text-white/50 hover:text-primary transition-colors">Lake Homes
                            </RouterLink>
                            <span class="text-white/20">•</span>
                            <RouterLink to="/homes/new-construction"
                                class="text-xs text-white/50 hover:text-primary transition-colors">New Construction
                            </RouterLink>
                        </div>
                    </div>
                ...
                <div class="flex justify-center lg:justify-end">
                    <div class="glass-card rounded-2xl p-8 max-w-md w-full border border-white/10">
                        ...
                        <LeadForm source="homepage-hero" variant="default" submit-label="Get Started"
